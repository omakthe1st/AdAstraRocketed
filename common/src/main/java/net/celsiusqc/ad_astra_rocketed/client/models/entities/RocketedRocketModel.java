...
public class RocketedRocketModel<T extends RocketedRocket> extends RocketModel<T> {
    ...
    public static final ModelLayerLocation TIER_6_LAYER = new ModelLayerLocation(new ResourceLocation(AdAstraRocketed.MOD_ID, "tier_5_rocket"), "main");
    public static final ModelLayerLocation TIER_7_LAYER = new ModelLayerLocation(new ResourceLocation(AdAstraRocketed.MOD_ID, "tier_5_rocket"), "main");
